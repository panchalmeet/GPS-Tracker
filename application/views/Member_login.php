...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">SignIn  <b>Tracker</b></a>
            <small></small>
        </div>
        <div class="card">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#login").click(function(){
            $.ajax({
                url:'<?= site_url("Member_login/client_login"); ?>',
                type:'post',
...
var username = msg.substr(1,40);
var type = msg.substr(0,1);
  ...
  function frame() {
    if (width >= 100) {
        $(".msg").html('Welcome '+username);
       
           if (type=='1') {
             window.location.href="<?= site_url('Members/dashboard'); ?>";        
         }else if(type=='2'){
             window.location.href="<?= site_url('Head/dashboard'); ?>";        
         }else if (type=='3') {
             window.location.href="<?= site_url('Admin/dashboard'); ?>";        
         }
         else if (type=='4') {
             window.location.href="<?= site_url('Comitee/dashboard'); ?>";        
         }

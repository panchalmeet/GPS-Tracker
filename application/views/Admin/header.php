    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../../index.html">Tracker</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="<?=site_url('Admin/profile');?>" class="">
                    ...
                    <li class="active">
                        <a href="<?=site_url('Admin/logout');?>" class="menu-toggle">
